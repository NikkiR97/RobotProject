...
try:
    forward(0.5) #read as 39
    print("count for forward" + str(counter1) + " " + str(counter2) + "\n")
    while(not(counter1 == 39) or not(counter2==39)): 
            if (counter1< 39):
                adjust_right_wheels(0.1)
            #elif (counter1>39):
             #   turn_right_b(0.01)                
            if(counter2<39):
                adjust_left_wheels(0.1)
            #elif (counter2>=11300):
             #   turn_left_b(0.01)              
            Stop(0.25)
